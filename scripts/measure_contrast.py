...
PAIRS = [
    ...
    ("primary text on graphite-950", "text", "graphite-950", 4.5, "text"),
    ("primary text on graphite-900", "text", "graphite-900", 4.5, "text"),
    ("primary text on graphite-850", "text", "graphite-850", 4.5, "text"),
    ("secondary text on black", "text-secondary", "black", 4.5, "text"),
    ("secondary text on graphite-900", "text-secondary", "graphite-900", 4.5, "text"),
    ("secondary text on graphite-850", "text-secondary", "graphite-850", 4.5, "text"),
    ("muted text on black", "text-muted", "black", 4.5, "text"),
    ("muted text on graphite-900", "text-muted", "graphite-900", 4.5, "text"),
    ("muted text on graphite-850", "text-muted", "graphite-850", 4.5, "text"),
    ("muted text on graphite-800", "text-muted", "graphite-800", 4.5, "text"),
    ("authority red text on black", "red", "black", 4.5, "text"),
    ("authority red text on graphite-850", "red", "graphite-850", 4.5, "text"),
    ("authority red on primary-action red-black", "red", "red-black", 4.5, "text"),
    ("believed amber on graphite-900", "amber", "graphite-900", 4.5, "text"),
    ("verified tone on graphite-900", "verified", "graphite-900", 4.5, "text"),
    ("focus outline red on black", "red", "black", 3.0, "ui"),
]
